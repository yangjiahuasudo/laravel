...
<blockquote class="layui-elem-quote" style="height:10px;color: red">店内精选可以选择多种商品进行首页展示</blockquote>
...
<!--                                    <th>
                                ...
                                <tbody>
                                    ...
                                    <tr  @if($goods_detail['selection_status'] == 1)class="layui-bg-green"@endif>
<!--                                    <td>
                                    ...
                                    <td class="">
                                          @if($goods_detail['selection_status'] == 1)
...
<!--                                      <a onclick="member_stop(this,'10001')" href="javascript:;"  title="启用">
                                      ...
                                      @if($goods_detail['selection_status'] !== 1)
                                        <a title="上线" onclick="selection_status_online(this,'{{ $goods_detail['id'] }}')" href="javascript:;">
                                            <i class="layui-icon"style="font-size: 30px; color:red;">&#xe619;</i>
                                        </a>
                                      @else
                                        <a title="下线" onclick="selection_status_downline(this,'{{ $goods_detail['id'] }}')" href="javascript:;">
                                            <i class="layui-icon"style="font-size: 30px; color:red;">&#xe61a;</i>
                                        </a>
                                     @endif
...
<!--                        <div class="layui-card-body ">
    ...
    <script>
      ...
      /*商品上线*/
      function selection_status_online(obj,id){
//          console.log(id);
          layer.confirm('确认要指定店内精选吗？',function(index){
              //发异步删除数据
                $.ajax({
                    url:'/admin/manager/fourth_online',
                    type:'post',
...
//                            xadmin.father_reload();
      ...
      /*商品下线*/
      function selection_status_downline(obj,id){
          console.log(id);
          layer.confirm('确认要下线吗？',function(index){
              //发异步删除数据
                $.ajax({
                    url:'/admin/manager/fourth_downline',
                    type:'post',
                    data:{id:id,_token:'{{csrf_token()}}'},
    //                contentType: "application/json; charset=utf-8",
                    traditional:true,
