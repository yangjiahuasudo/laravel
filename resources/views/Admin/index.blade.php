...
<html class="x-admin-sm">
    ...
    <body class="index">
        ...
        <div class="container">
            <div class="logo">
                <a href="/X-admin/index.html">后台管理</a></div>
            <div class="left_open">
...
<!--                            <li>
                            ...
                            <li>
                                <a onclick="xadmin.add_tab('用户列表','/admin/member-list')">
                                    <i class="iconfont">&#xe6a7;</i>
                                    <cite>用户列表</cite></a>
                            </li>
<!--                            <li>
                            ...
                            <li>
                                <a onclick="xadmin.add_tab('用户删除','/admin/member-list-del')">
                                    <i class="iconfont">&#xe6a7;</i>
                                    <cite>用户删除</cite></a>
                            </li>
<!--                            <li>
                    ...
                    <li>
                        ...
                        <ul class="sub-menu">
                            <li>
                                <a onclick="xadmin.add_tab('上线轮播','/admin/lunbo-list')">
                                    <i class="iconfont">&#xe6a7;</i>
                                    <cite>上线轮播</cite></a>
                            </li>
                            <li>
                                <a onclick="xadmin.add_tab('下线轮播','/admin/lunbo-list-down')">
                                    <i class="iconfont">&#xe6a7;</i>
                                    <cite>下线轮播</cite></a>
                            </li>
                            <li>
                                <a onclick="xadmin.add_tab('添加轮播','/admin/lunbo-add')">
                                    <i class="iconfont">&#xe6a7;</i>
                                    <cite>添加轮播</cite></a>
                            </li>
                        </ul>
                    ...
                    <li>
                        ...
                        <ul class="sub-menu">
                            <li>
                                <a onclick="xadmin.add_tab('上线楼层','/admin/floor-list')">
                                    <i class="iconfont">&#xe6a7;</i>
                                    <cite>上线楼层</cite></a>
                            </li>
                            <li>
                                <a onclick="xadmin.add_tab('添加轮播','/admin/floor-add')">
                                    <i class="iconfont">&#xe6a7;</i>
                                    <cite>创建</cite></a>
                            </li>
                    ...
                    <li>
                        <a href="javascript:;">
                            <i class="iconfont left-nav-li" lay-tips="店长推荐">&#xe723;</i>
                            <cite>首页管理</cite>
                            <i class="iconfont nav_right">&#xe697;</i></a>
                        <ul class="sub-menu">
                            @foreach($floors as $floor)
                            <li>
                                <a onclick="xadmin.add_tab('{{ $floor->name }}','/admin/manager/{{$floor->id}}')">
                                    <i class="iconfont">&#xe6a7;</i>
                                    <cite>{{ $floor->name }}</cite></a>
                            </li>
                            @endforeach
                        </ul>
                    </li>
                    ...
                    <li>
                        ...
                        <ul class="sub-menu">
                            ...
                            <li>
                                <a onclick="xadmin.add_tab('分类删除','/admin/cate-list-del')">
                                    <i class="iconfont">&#xe6a7;</i>
                                    <cite>分类删除</cite></a>
                            </li>
                        </ul>
                    ...
                    <li>
                        ...
                        <ul class="sub-menu">
                            <li>
                                <a onclick="xadmin.add_tab('全部商品','/admin/goods-list')">
                                    <i class="iconfont">&#xe6a7;</i>
                                    <cite>全部商品</cite></a>
                            </li>
                            <li>
                                <a onclick="xadmin.add_tab('添加商品','/admin/goods-add')">
                                    <i class="iconfont">&#xe6a7;</i>
                                    <cite>添加商品</cite></a>
                            </li>
                        </ul>
                    ...
                    <li>
                        <a href="javascript:;">
                            <i class="iconfont left-nav-li" lay-tips="商品分类">&#xe723;</i>
                            <cite>商品分类</cite>
                            <i class="iconfont nav_right">&#xe697;</i></a>
                        <ul class="sub-menu">
                             @foreach($cates as $cate)
                            <li>
                                <a onclick="xadmin.add_tab('{{ $cate->name }}','/admin/goods-cate/{{$cate->id}}')">
                                    <i class="iconfont">&#xe6a7;</i>
                                    <cite>{{ $cate->name }}</cite></a>
                            </li>
                            @endforeach
                            <li>
                                <a onclick="xadmin.add_tab('其他','/admin/goods-cate/-1')">
                                    <i class="iconfont">&#xe6a7;</i>
                                    <cite>其他</cite></a>
                            </li>
                        </ul>
                    ...
                    <li>
                        ...
                        <ul class="sub-menu">
                            <li>
                                <a onclick="xadmin.add_tab('区域列表','order-list.html')">
                                    <i class="iconfont">&#xe6a7;</i>
                                    <cite>区域列表</cite></a>
                            </li>
                            <li>
                                <a onclick="xadmin.add_tab('待定区域','order-list1.html')">
                                    <i class="iconfont">&#xe6a7;</i>
                                    <cite>待定区域</cite></a>
                            </li>
                        </ul>
