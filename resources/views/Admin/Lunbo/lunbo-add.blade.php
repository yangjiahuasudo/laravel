                ...
                <form class="layui-form">
                    ...
                    <div class="layui-form-item">
                        <label for="L_username" class="layui-form-label">
                            <span class="x-red">*</span>轮播名称</label>
...
<!--                    <div class="layui-form-item">
                    ...
                    <div class="layui-form-item">
                        <label for="L_username" class="layui-form-label">
                            <span class="x-red">*</span>轮播描述</label>
                        <div class="layui-input-inline">
                           <textarea name="desc" required lay-verify="required" placeholder="请输入商品描述。。。" class="layui-textarea"></textarea>
                    </div>
                    </div>
                    <div class="layui-form-item">
                        <label for="L_username" class="layui-form-label">
...
layui.use('upload', function(){
  ...
  var uploadInst = upload.render({
    ...
    url: '/admin/lunbo/picture/upload', //上传接口
    before: function(obj) {
        //预读本地文件示例，不支持ie8
