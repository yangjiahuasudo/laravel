...
<!--                                      <a onclick="member_stop(this,'10001')" href="javascript:;"  title="启用">
                                      ...
                                      <a title="编辑" id="bianji"  onclick="xadmin.open('编辑','/admin/lunbo-edit/{{ $lunbo['id'] }}',700,500)" href="javascript:;">
                                        <i class="layui-icon">&#xe642;</i>
                                      </a>
<!--                                      <a onclick="xadmin.open('修改密码','/admin/member-password/{{ $lunbo['id'] }}',600,400)" title="修改密码" href="javascript:;">
                                        <i class="layui-icon">&#xe631;</i>
                                      </a>-->
                                      <a title="下线" onclick="member_del(this,'{{ $lunbo['id'] }}')" href="javascript:;">
                                        <i class="layui-icon">&#xe61a;</i>
                                      </a>
                                    </td>
                                  </tr>
