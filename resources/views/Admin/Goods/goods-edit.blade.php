...
<!--                    <div class="layui-form-item">
                    ...
                    <input type="hidden" name="id" value="{{ $goods_detail['0']['id'] }}"> 
                    <div class="layui-form-item">
                        <label for="L_username" class="layui-form-label">
                            <span class="x-red">*</span>名称</label>
                        <div class="layui-input-inline">
                            <input type="text" id="L_username" name="goods_name" value="{{ $goods_detail['0']['goods_name'] }}" required="" lay-verify="" autocomplete="off" class="layui-input"></div>
                    </div>
                    <div class="layui-form-item">
                        <label for="L_username" class="layui-form-label">
                            ...
                            <div class="layui-input-inline">
                                <select name="goods_cate" lay-verify="">
                                    ...
                                    <option value="{{ $cate['id'] }}"  @if($cate['name'] == $goods_detail['0']['goods_cate']) selected="selected" @endif >{{ $cate['name'] }}</option>
                                    @endforeach
                                </select> 
                            </div>
                    </div>
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-inline">
                            <input type="text" id="" name="goods_price" value="{{ $goods_detail['0']['goods_price'] }}" required="" lay-verify="" autocomplete="off" class="layui-input"></div>
                    </div>
                    <div class="layui-form-item">
                        <label for="L_username" class="layui-form-label">
                            <span class="x-red">*</span>描述</label>
                        <div class="layui-input-inline">
                            <textarea name="goods_desc" required lay-verify="required" placeholder="请输入商品描述。。。" class="layui-textarea">{{ $goods_detail['0']['goods_desc'] }}</textarea>
                        </div>
                    </div>
                    <div class="layui-form-item">
                        <label for="L_username" class="layui-form-label">
                        ...
                        <div class="layui-input-inline">
                            <img id="pic_old" src="{{$goods_detail['0']['goods_picture']}}" style="width:90%">
                    </div>
                    </div>
...
layui.use('upload', function(){
  ...
  var uploadInst = upload.render({
    ...
    multiple : false,//多文件
    data:{pic_old:pic_old},
    url: '/admin/goods/picture/upload_del', //上传接口
    before: function(obj) {
        //预读本地文件示例，不支持ie8
