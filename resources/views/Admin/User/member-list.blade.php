...
<!--                                      <a onclick="member_stop(this,'10001')" href="javascript:;"  title="启用">
                                      ...
                                      <a title="编辑" id="bianji"  onclick="xadmin.open('编辑','/admin/member-edit/{{ $user->id }}',600,400)" href="javascript:;">
                                        <i class="layui-icon">&#xe642;</i>
                                      </a>
                                      <a onclick="xadmin.open('修改密码','/admin/member-password/{{ $user->id }}',600,400)" title="修改密码" href="javascript:;">
                                        <i class="layui-icon">&#xe631;</i>
                                      </a>
