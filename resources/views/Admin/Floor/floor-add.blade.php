                ...
                <form class="layui-form">
                    ...
                    <div class="layui-form-item">
                        <label for="L_username" class="layui-form-label">
                            <span class="x-red">*</span>楼层名称</label>
                    ...
                    <div class="layui-form-item">
                        <label for="L_username" class="layui-form-label">
                            <span class="x-red">*</span>楼层小标题</label>
                        <div class="layui-input-inline">
...
<!--                    <div class="layui-form-item">
                    ...
                    <div class="layui-form-item">
                        <label for="L_username" class="layui-form-label">
                            <span class="x-red">*</span>楼层描述</label>
                        <div class="layui-input-inline">
                           <textarea name="desc" required lay-verify="required" placeholder="请输入楼层描述。。。" class="layui-textarea"></textarea>
                    </div>
                    </div>
                    <div class="layui-form-item">
                        <label for="L_username" class="layui-form-label">
                    ...
                    <div class="layui-form-item">
                        ...
                        <button class="layui-btn layui-btn-danger" lay-filter="add" lay-submit="">确认增加</button></div>
                </form>
            </div>
        </div>
...
layui.use('upload', function(){
  ...
  var uploadInst = upload.render({
    ...
    url: '/admin/floor/picture/upload', //上传接口
    before: function(obj) {
        //预读本地文件示例，不支持ie8
