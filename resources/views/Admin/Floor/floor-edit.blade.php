            ...
            <div class="layui-row">
                <form class="layui-form">
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-inline">
                            <input type="text" id="L_username" name="title" value="{{$lunbo['0']['title']}}" required="" lay-verify="nikename" autocomplete="off" class="layui-input"></div>
                    </div>
...
//    headers: {'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')},//若没有排除post上传图片的令牌验证，就需要将此处取消注释
    ...
    url: '/admin/floor/picture/upload_del', //上传接口
